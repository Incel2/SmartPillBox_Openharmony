...
// #define SSD1306_I2C_SPEED       400000       // 400KHz
...
#define X_WIDTH 	128
#define Y_WIDTH 	64
#define BUFFER_SIZE (X_WIDTH * Y_WIDTH / 8)

#define OLED_CMD  0	//写命令
#define OLED_DATA 1	//写数据

// uint8_t oled_buffer1[BUFFER_SIZE] = {0}; // 缓冲区1
// uint8_t oled_buffer2[BUFFER_SIZE] = {0}; // 缓冲区2
// uint8_t *current_buffer = oled_buffer1;  // 绘制缓冲区
// uint8_t *display_buffer = oled_buffer2;  // 显示缓冲区

// extern uint8_t oled_buffer1[BUFFER_SIZE];
// extern uint8_t oled_buffer2[BUFFER_SIZE];
// extern uint8_t *current_buffer;
// extern uint8_t *display_buffer;

// extern uint8_t oled_buffer1[128][8];
// extern uint8_t oled_buffer2[128][8];
// extern uint8_t (*current_buffer)[8];
